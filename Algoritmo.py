...
if lula.getvida <= 0:
    print(f"Bolsonaro venceu, BRASIL ACIMA DE TUDO, DEUS ACIMA DE TODOS!\n{time.sleep(2)} Tente em uma próxima... :(")
    time.sleep(3)
    os.system("cls")
    print(F"Bolsonaro está evoluindo para sua última forma, cuidado...!\n{time.sleep(2)}SUPER BOLSONARO MAÇOM!! >:D")
elif bolsonaro.getvida <= 0:
    print(f"Lula venceu, FAZ O L!\n{time.sleep(2)}Tente em uma próxima... :(")
    time.sleep(3)
    os.system("cls")
    print(F"Lula está evoluindo para a sua última forma, cuidado...!\n{time.sleep(2)}LULA BOTEQUEIRO TOMANDO UMA CERVEJINHA! >:D")